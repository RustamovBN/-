...
print("Средний балл студента:", average_student_grade)
print("Самый сложный предмет:", hardest_subject)
print("Самый легкий предмет:", easiest_subject)
print("Лучший показатель:", best_grade_level)
print("Худший показатель:", worst_grade_level)
print("Лучший ID студента:", best_student)
print("худший ID студента:", worst_student)
